...
**Recall.** Why is persisting the transcript enough to make a run resumable — you
...
handler nodes — the path depends on the state) and a **cycle** (the review gate routes
